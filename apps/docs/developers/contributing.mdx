...
<Tip>
**Quick Setup**: New contributors can use `npx @heygaia/cli init` to automatically set up their development environment. This guide covers the manual process for those who prefer full control.
</Tip>
